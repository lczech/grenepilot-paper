...
$GRENEDALF fst --pileup-path $DATA --window-width 10000 --method spence-nei --omit-na-windows --pool-sizes ${POOLS} --sample-name-list ${NAMES} --file-suffix "-width-10k" --threads 4 > grenedalf-fst-width-10k.log

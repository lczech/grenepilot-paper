...
p_R1T1 <- ggplot(francois, aes(x=S1, y=R1T1)) + geom_point(alpha = 1/100) + xlab("") + ylab("Replicate 1") #+ ggtitle("R1T1")
p_R1T2 <- ggplot(francois, aes(x=S1, y=R1T2)) + geom_point(alpha = 1/100) + xlab("") + ylab("") #+ ggtitle("R1T2")
p_R1T3 <- ggplot(francois, aes(x=S1, y=R1T3)) + geom_point(alpha = 1/100) + xlab("") + ylab("") #+ ggtitle("R1T3")
p_R2T1 <- ggplot(francois, aes(x=S2, y=R2T1)) + geom_point(alpha = 1/100) + xlab("") + ylab("Replicate 2") #+ ggtitle("R2T1")
p_R2T2 <- ggplot(francois, aes(x=S2, y=R2T2)) + geom_point(alpha = 1/100) + xlab("") + ylab("") #+ ggtitle("R2T2")
p_R2T3 <- ggplot(francois, aes(x=S2, y=R2T3)) + geom_point(alpha = 1/100) + xlab("") + ylab("") #+ ggtitle("R2T3")
p_R3T1 <- ggplot(francois, aes(x=S3, y=R3T1)) + geom_point(alpha = 1/100) + xlab("Time 1") + ylab("Replicate 3") #+ ggtitle("R3T1")
p_R3T2 <- ggplot(francois, aes(x=S3, y=R3T2)) + geom_point(alpha = 1/100) + xlab("Time 2") + ylab("") #+ ggtitle("R3T2")
p_R3T3 <- ggplot(francois, aes(x=S3, y=R3T3)) + geom_point(alpha = 1/100) + xlab("Time 3") + ylab("") #+ ggtitle("R3T3")
...
ggsave("test_delta_8x8_300.png", width=8, height=8, dpi=300)
